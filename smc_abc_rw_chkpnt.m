function [part_vals, part_sim, part_s, sims,dist_t,p_acc_t] = smc_abc_rw(D,...
                                                 ...
                                                 a,c,p_acc_min,checkpointfile,finish)
...
% checkpointfile - name of checkpoint file, if the file exists then state is loaded
%                  from this file instead of re-starting. 
%
% Returns:
...
% load previous state if checkpoint file present
